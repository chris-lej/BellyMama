...
export const ContactBubbleIcon = () => (
  <svg className="bi bi-chat-dots mr-2 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
...
export default ContactBubbleIcon;
